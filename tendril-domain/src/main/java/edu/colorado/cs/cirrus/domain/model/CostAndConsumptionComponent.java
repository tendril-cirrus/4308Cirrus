...
public class CostAndConsumptionComponent {
     ...
     * Constructs a new instance.
     *
     * @param actualReadingsCount The actualReadingsCount for this instance.
     * @param toDate The toDate for this instance.
     * @param fromDate The fromDate for this instance.
     * @param peak The peak for this instance.
     * @param rateKey The rateKey for this instance.
     ...
     */
    public CostAndConsumptionComponent(String actualReadingsCount, String toDate, String fromDate, String peak, String rateKey, float cost, float consumption, List<CostAndConsumptionComponent> componentList)
    {
     ...
     *
     * @param actualReadingsCount The actualReadingsCount.
     */
