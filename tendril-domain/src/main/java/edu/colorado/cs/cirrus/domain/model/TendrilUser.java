...
public class TendrilUser implements IUser {
     ...
     *            ;
     */
    public TendrilUser(Integer id, String firstName, String lastName, String email, String username, String authorId,
            boolean expert, boolean usingTemporaryPassword) {
        this.setId(id);
     ...
     * 
     */
    public TendrilUser(String json) {
        TendrilUser myObject = JSONUtils.getJsonAsObject(json, TendrilUser.class);
    ...
    public String toJSON() {
        return JSONUtils.getObjectAsJson(this, TendrilUser.class);
    }
