...
public class Device {
    ...
    public Device(String deviceId, String networkId, String category, String name, String marketingName,
            List<ExtendedProperty> extendedPropertyList, List<String> supportedOperationList) {
        super();
    ...
    public String toString() {
        return "Device [deviceId=" + deviceId + ", networkId=" + networkId + ", category=" + category + ", name="
                + name + ", marketingName=" + marketingName + ", extendedPropertyList=" + extendedPropertyList
