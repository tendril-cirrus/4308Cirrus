...
public class TendrilOAuth2Template implements OAuth2Operations {
	...
	public TendrilOAuth2Template(String clientId, String clientSecret, String authorizeUrl, String accessTokenUrl) {
		this(clientId, clientSecret, authorizeUrl, null, accessTokenUrl);
	}
	
	public TendrilOAuth2Template(String clientId, String clientSecret, String authorizeUrl, String authenticateUrl, String accessTokenUrl) {
	...
	/**
	 * Overriding original since Tendril currently supports GET, not the standard POST
	 * 
	 * 
	 */
	...
	protected AccessGrant getForAccessGrant(String accessTokenUrl,
		...
		System.err.println(accessTokenUrl + " " + params);
		
		String url = "http://dev.tendrilinc.com/oauth/access_token?client_id=925272ee5d12eac858aeb81949671584&client_secret=3230f8f0aa064bea145d425c57fe8679&code=faaf748d295e2f70133f7ef31bac1525&redirect_uri=x-org-springsource-android-showcase://tendril-oauth-response&grant_type=authorization_code";
		//System.err.println("Headers: " + restTemplate.headForHeaders("http://dev.tendrilinc.com/connect/user/current-user").toString());
		
		
		Map<String, Object> ag = restTemplate.getForObject(url,  Map.class, params);
		System.err.println(ag);
				
		return extractAccessGrant(ag);
