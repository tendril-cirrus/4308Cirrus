...
public class TendrilWebOAuthActivity extends AbstractWebViewActivity {
    ...
    private static final String TAG = TendrilWebOAuthActivity.class.getSimpleName();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        this.connectionFactory = getApplicationContext().getTendrilConnectionFactory();
    }
    ...
    private String getAuthorizeUrl() {
        ...
        //TODO: change to android uri
        params.setRedirectUri("http://www.google.com");
        params.add("state", "colorado");
        String url = connectionFactory.getOAuthOperations().buildAuthorizeUrl(GrantType.AUTHORIZATION_CODE, params);
...
//                    Connection<Tendril> connection = connectionFactory.createConnection(accessGrant);
//
//                    try {
