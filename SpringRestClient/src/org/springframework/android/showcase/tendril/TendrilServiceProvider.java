...
import org.springframework.social.oauth2.TendrilOAuth2Template;
...
public class TendrilServiceProvider extends AbstractOAuth2ServiceProvider<Tendril> {
	...
	public TendrilServiceProvider(String clientId, String clientSecret) {
		super(new TendrilOAuth2Template(clientId, clientSecret,"http://dev.tendrilinc.com/oauth/authorize","http://dev.tendrilinc.com/oauth/access_token" ));
	}
